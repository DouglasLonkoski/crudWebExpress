...
app.get("/update/:id",function(req,res){
 ...
 app.post("/controllerUpdate",urlencodeParser,function(req,res){
    sql.query("update task set name=?, description=?, start_date=?, end_date=?, priority=? where id=?",[req.body.name,req.body.description, req.body.start_date, req.body.end_date, req.body.priority, req.body.id]);
    res.render('controllerUpdate');
 });
 
app.listen(3004, function(req, res){console.log('Servidor está rodando!')})